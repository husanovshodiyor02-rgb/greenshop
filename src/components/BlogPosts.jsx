    ...
    <section className="container1">
      ...
      <div className="flex items-center justify-between flex-wrap my-15">
        ...
        <div>
          ...
          <div className="sm:w-[354px] w-65 h-10 rounded-md shadow-[0_0_20px_0_rgba(0,0,0,0.06)] bg-white flex items-center justify-between my-3">
            <input
              type="text"
              placeholder="enter your email address..."
              className="pl-3"
            />
            <button className="w-[85px] h-10 rounded-[0_6px_6px_0] bg-[#46a358] font-bold text-lg leading-[89%] text-white px-1.5">
              Join
            </button>
          </div>
          <p className="font-normal text-sm leading-[157%] text-[#727272]">
